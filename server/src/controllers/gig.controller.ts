...
export const createGig = async (req: CustomRequest, res: Response, next: NextFunction) => {
  if (!req.isSeller)
...
export const deleteGig = async (req: CustomRequest, res: Response, next: NextFunction) => {
  try {
